...
# dash core components are not listed in the layout. in the layout there is only a button and en empty Div
# where we put all the componetnts, graphs the user will create
